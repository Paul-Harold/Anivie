...
axios.interceptors.request.use(
  (config) => {
    // 1. If talking to external APIs, strip the authorization header so they don't block us!
    if (config.url.includes('jikan.moe') || config.url.includes('themoviedb.org')) {
